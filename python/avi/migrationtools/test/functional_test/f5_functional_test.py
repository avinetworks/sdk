...
class Tester():
    ...
    def __init__(self):
        ...
        self.f5_config_dict = self.f5_config_dict
        self.avi_config_dict = self.avi_config_dict
       ...
       for each_vs in self.avi_config_dict['VirtualService']:
            ...
            if exist:
                if 'application_profile_ref' in each_vs:
                    ...
                    app_type = [i['type'] for i in self.avi_config_dict['ApplicationProfile'] if i['name']==app_name]
                    self.test_getApplicationType(app_type[0],self.f5_config_dict)
            else:
                print vs_name
