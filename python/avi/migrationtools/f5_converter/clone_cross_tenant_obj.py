...
avi_object_types = (
    ...
    'Pool', 'TrafficCloneProfile', 'Network', 'ServerAutoScalePolicy',
    'AlertConfig', 'ActionGroupConfig', 'PriorityLabels', 'VrfContext',
    'GslbService', 'AlertEmailConfig', 'Backup', 'Cloud',
    'NetworkSecurityPolicy', 'HealthMonitor', 'SystemConfiguration',
    'Scheduler', 'ApplicationProfile', 'IpamDnsProviderProfile', 'WafPolicy',
    'MicroServiceGroup', 'AnalyticsProfile', 'SSLKeyAndCertificate',
    'ErrorPageProfile', 'ClusterCloudDetails', 'BackupConfiguration',
    'IpAddrGroup', 'NetworkProfile', 'AlertScriptConfig',
    'CustomIpamDnsProfile', 'WafProfile', 'SSLProfile', 'AlertSyslogConfig',
    'PKIProfile', 'Cluster', 'StringGroup', 'Webhook',
    'CertificateManagementProfile', 'AutoScaleLaunchConfig', 'ErrorPageBody',
