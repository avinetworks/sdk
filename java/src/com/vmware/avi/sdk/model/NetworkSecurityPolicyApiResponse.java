 ...
 */
public class NetworkSecurityPolicyApiResponse {
  @JsonProperty("count")
  ...
  public NetworkSecurityPolicyApiResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public NetworkSecurityPolicyApiResponse results(List<NetworkSecurityPolicy> results) {
