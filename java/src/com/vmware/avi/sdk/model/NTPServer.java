...
public class NTPServer {
  ...
  public NTPServer keyNumber(Integer keyNumber) {
   ...
   * @return keyNumber
  **/
  @Schema(description = "Key number from the list of trusted keys used to authenticate this server. Allowed values are 1-65534.")
  ...
  public NTPServer server(IpAddr server) {
    this.server = server;
    return this;
  }
