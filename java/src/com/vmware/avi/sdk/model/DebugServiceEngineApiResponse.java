 ...
 */
public class DebugServiceEngineApiResponse {
  @JsonProperty("count")
  ...
  public DebugServiceEngineApiResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public DebugServiceEngineApiResponse results(List<DebugServiceEngine> results) {
