...
public class PortRange {
   ...
   * @return end
  **/
  @Schema(required = true, description = "TCP/UDP port range end (inclusive). Allowed values are 1-65535.")
   ...
   * @return start
  **/
  @Schema(required = true, description = "TCP/UDP port range start (inclusive). Allowed values are 1-65535.")
