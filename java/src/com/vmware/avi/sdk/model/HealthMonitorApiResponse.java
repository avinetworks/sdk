 ...
 */
public class HealthMonitorApiResponse {
  @JsonProperty("count")
  ...
  public HealthMonitorApiResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public HealthMonitorApiResponse results(List<HealthMonitor> results) {
