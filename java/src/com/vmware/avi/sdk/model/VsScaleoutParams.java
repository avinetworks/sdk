...
public class VsScaleoutParams {
  ...
  public VsScaleoutParams adminUp(Boolean adminUp) {
   ...
   * @return adminUp
  **/
  @Schema(description = "Placeholder for description of property admin_up of obj type VsScaleoutParams field type str  type boolean")
  ...
  public VsScaleoutParams newVcpus(Integer newVcpus) {
  ...
  **/
  ...
  public VsScaleoutParams toHostRef(String toHostRef) {
  ...
  **/
  ...
  public VsScaleoutParams toNewSe(Boolean toNewSe) {
   ...
   * @return toNewSe
  **/
  @Schema(description = "Placeholder for description of property to_new_se of obj type VsScaleoutParams field type str  type boolean")
  ...
  public VsScaleoutParams toSeRef(String toSeRef) {
  ...
  **/
  ...
  public VsScaleoutParams uuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  **/
  ...
  public VsScaleoutParams vipId(String vipId) {
    this.vipId = vipId;
    return this;
  }
