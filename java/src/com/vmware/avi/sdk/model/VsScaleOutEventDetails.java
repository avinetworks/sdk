...
public class VsScaleOutEventDetails  {
   ...
   * Placeholder for description of property error_message of obj type vsscaleouteventdetails field type str  type string.
   * @return errorMessage
   */
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Placeholder for description of property ip of obj type vsscaleouteventdetails field type str  type string.
   * @return ip
   */
  public String getIp() {
    return ip;
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Placeholder for description of property ip6 of obj type vsscaleouteventdetails field type str  type string.
   * @return ip6
   */
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Placeholder for description of property rpc_status of obj type vsscaleouteventdetails field type str  type integer.
   * @return rpcStatus
   */
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Placeholder for description of property scale_status of obj type vsscaleouteventdetails field type str  type ref.
   * @return scaleStatus
   */
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Placeholder for description of property se_assigned of obj type vsscaleouteventdetails field type str  type array.
   * @return seAssigned
   */
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Placeholder for description of property se_requested of obj type vsscaleouteventdetails field type str  type ref.
   * @return seRequested
   */
