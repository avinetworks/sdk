...
public class AuthenticationMatch {
  ...
  public AuthenticationMatch clientIp(IpAddrMatch clientIp) {
  ...
  **/
  ...
  public AuthenticationMatch hostHdr(HostHdrMatch hostHdr) {
  ...
  **/
  ...
  public AuthenticationMatch path(PathMatch path) {
    this.path = path;
    return this;
  }
