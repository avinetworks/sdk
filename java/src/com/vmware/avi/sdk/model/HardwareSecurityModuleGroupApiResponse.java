 ...
 */
public class HardwareSecurityModuleGroupApiResponse {
  @JsonProperty("count")
  ...
  public HardwareSecurityModuleGroupApiResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public HardwareSecurityModuleGroupApiResponse results(List<HardwareSecurityModuleGroup> results) {
