 ...
 */
public class VSDataScriptSetApiResponse {
  @JsonProperty("count")
  ...
  public VSDataScriptSetApiResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public VSDataScriptSetApiResponse results(List<VSDataScriptSet> results) {
