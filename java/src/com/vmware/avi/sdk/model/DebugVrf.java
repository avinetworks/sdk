...
public class DebugVrf {
  ...
  public DebugVrf flag(String flag) {
    this.flag = flag;
    return this;
  }
   ...
   * @return flag
  **/
  @Schema(required = true, description = " Enum options - DEBUG_VRF_BGP, DEBUG_VRF_QUAGGA, DEBUG_VRF_ALL, DEBUG_VRF_NONE. Field introduced in 17.1.1.")
