...
type DNSRrSet struct {
	...
	// Canonical name in CNAME record. Field introduced in 18.1.2.
	Cname *DNSCnameRdata `json:"cname,omitempty"`

	// Fully Qualified Domain Name. Field introduced in 18.1.2.
	// Required: true
	...
	// IP address in A record. Field introduced in 18.1.2.
	IPAddresses []*DNSARdata `json:"ip_addresses,omitempty"`

	// Name Server information in NS record. Field introduced in 18.1.2.
	Nses []*DNSNsRdata `json:"nses,omitempty"`

	// Time To Live for this DNS record. Allowed values are 0-2147483647. Field introduced in 18.1.2.
	// Required: true
	TTL int32 `json:"ttl"`
