...
type DebugVrfContext struct {
	...
	// Vrf config command buffer process interval. Allowed values are 1-4. Field introduced in 17.2.13,18.1.5.
	CommandBufferInterval *int32 `json:"command_buffer_interval,omitempty"`

	// Vrf config command buffer size. Allowed values are 1-32768. Field introduced in 17.2.13,18.1.5.
