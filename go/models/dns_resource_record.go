...
type DNSResourceRecord struct {
	...
	// Fully qualified domain name of a mail server in the MX record. Field introduced in 20.1.1.
	...
	// The priority field identifies which mail server should be preferred. Field introduced in 20.1.1.
	Priority *int32 `json:"priority,omitempty"`

	// Site controller cluster name - applicable only for Avi VS GSLB member.
	SiteName *string `json:"site_name,omitempty"`

	// Text resource record. Field introduced in 20.1.1.
