...
type SipLog struct {
	...
	// SIP CallId header. Field introduced in 17.2.12.
	SipCallidHdr string `json:"sip_callid_hdr,omitempty"`

	// Client's SIP Contact header. Field introduced in 17.2.12.
	SipContactHdr string `json:"sip_contact_hdr,omitempty"`

	// SIP From header. Field introduced in 17.2.12.
	SipFromHdr string `json:"sip_from_hdr,omitempty"`

	// SIP Messages. Field introduced in 17.2.12.
	SipMessages []*SipMessage `json:"sip_messages,omitempty"`

	// SIP To header. Field introduced in 17.2.12.
