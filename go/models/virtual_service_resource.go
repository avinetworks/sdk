...
type VirtualServiceResource struct {
	...
	// This field is not being used. Field deprecated in 18.1.5.
	...
	// Indicates if the primary SE is being scaled in. This state is now derived from the Virtual Service runtime. Field deprecated in 18.1.5.
	ScaleinPrimary *bool `json:"scalein_primary,omitempty"`

	// Indicates which SE is being scaled in. This information is now derived from the Virtual Service runtime. Field deprecated in 18.1.5.
