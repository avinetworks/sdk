...
type TCPFastPathProfile struct {
	...
	// The amount of time (in sec) for which a connection needs to be idle before it is eligible to be deleted. Allowed values are 60-3600. Special values are 0 - 'infinite'.
