...
type WafConfig struct {
	...
	// Maximum size for the client request body scanned by WAF. Allowed values are 1-32768. Field introduced in 18.1.5.
	...
	// Ignore request body parsing errors due to partial scanning. Field introduced in 18.1.5.
