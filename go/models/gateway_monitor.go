...
type GatewayMonitor struct {
	...
	// The interval between two ping requests sent by the gateway monitor in milliseconds. If a value is not specified, requests are sent every second. Allowed values are 100-60000. Units(MILLISECONDS).
	...
	// Subnet providing reachability for Multi-hop Gateway. Field introduced in 17.2.3.
