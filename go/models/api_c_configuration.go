...
type APICConfiguration struct {
	...
	//  Field deprecated in 17.2.9,18.1.1.
	...
	// The password APIC will use when authenticating with Avi Vantage. Field deprecated in 17.2.9,18.1.1.
	AviControllerPassword string `json:"avi_controller_password,omitempty"`

	// The username APIC will use when authenticating with Avi Vantage. Field deprecated in 17.2.9,18.1.1.
	...
	// Use Managed Mode for APIC Service Insertion. Field deprecated in 17.2.9,18.1.1. Field introduced in 17.1.1.
	ManagedMode bool `json:"managed_mode,omitempty"`

	// AVI Device Package Minor Version. Field deprecated in 17.2.9,18.1.1.
	Minor string `json:"minor,omitempty"`

	// Determines if DSR from secondary SE is active or not  False  Automatically determine based on hypervisor type. True  Disable DSR unconditionally. . Field introduced in 17.2.10.
	SeTunnelMode bool `json:"se_tunnel_mode,omitempty"`

	// AVI Device Package Version. Field deprecated in 17.2.9,18.1.1.
