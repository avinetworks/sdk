...
type TCPProxyProfile struct {
	...
	// Congestion window scaling factor after recovery. Allowed values are 0-8. Field introduced in 17.2.12.
	...
	// Congestion window scaling factor during slow start. Allowed values are 0-8. Field introduced in 17.2.12.
