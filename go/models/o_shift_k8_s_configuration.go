...
type OShiftK8SConfiguration struct {
	...
	// Optional fleet remote endpoint if fleet is used for SE deployment. Field deprecated in 17.2.13,18.1.5.
	...
	// Nuage Overlay SDN Controller information. Field deprecated in 17.2.13,18.1.5.
	...
	// New SE spawn rate per minute. Field deprecated in 17.2.13,18.1.5.
