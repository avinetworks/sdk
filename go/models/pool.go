...
func (m *Pool) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAbPool(formats); err != nil {
		// prop
		res = append(res, err)
	}

	if err := m.validateAutoscaleNetworks(formats); err != nil {
		// prop
		res = append(res, err)
	}
	...
	if err := m.validateFailAction(formats); err != nil {
		// prop
		res = append(res, err)
	}

	if err := m.validateHealthMonitorRefs(formats); err != nil {
		// prop
		res = append(res, err)
	}

	if err := m.validateMaxConnRatePerServer(formats); err != nil {
		// prop
		res = append(res, err)
	}
	...
	if err := m.validateNsxSecuritygroup(formats); err != nil {
		// prop
		res = append(res, err)
	}

	if err := m.validatePlacementNetworks(formats); err != nil {
		// prop
		res = append(res, err)
	}

	if err := m.validateServerReselect(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *Pool) validateAbPool(formats strfmt.Registry) error {

	if swag.IsZero(m.AbPool) { // not required
		return nil
	}

	if m.AbPool != nil {

		if err := m.AbPool.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ab_pool")
			}
			return err
		}
	}
...
func (m *Pool) validateAutoscaleNetworks(formats strfmt.Registry) error {

	if swag.IsZero(m.AutoscaleNetworks) { // not required
		return nil
	}
...
func (m *Pool) validateDomainName(formats strfmt.Registry) error {
...
func (m *Pool) validateFailAction(formats strfmt.Registry) error {

	if swag.IsZero(m.FailAction) { // not required
		return nil
	}

	if m.FailAction != nil {

		if err := m.FailAction.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("fail_action")
			}
			return err
		}
	}
...
func (m *Pool) validateHealthMonitorRefs(formats strfmt.Registry) error {

	if swag.IsZero(m.HealthMonitorRefs) { // not required
		return nil
	}
...
func (m *Pool) validateMaxConnRatePerServer(formats strfmt.Registry) error {

	if swag.IsZero(m.MaxConnRatePerServer) { // not required
		return nil
	}

	if m.MaxConnRatePerServer != nil {

		if err := m.MaxConnRatePerServer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("max_conn_rate_per_server")
			}
			return err
		}
	}
...
func (m *Pool) validateNetworks(formats strfmt.Registry) error {
...
func (m *Pool) validateNsxSecuritygroup(formats strfmt.Registry) error {

	if swag.IsZero(m.NsxSecuritygroup) { // not required
		return nil
	}
...
func (m *Pool) validatePlacementNetworks(formats strfmt.Registry) error {

	if swag.IsZero(m.PlacementNetworks) { // not required
		return nil
	}

	for i := 0; i < len(m.PlacementNetworks); i++ {

		if swag.IsZero(m.PlacementNetworks[i]) { // not required
			continue
		}

		if m.PlacementNetworks[i] != nil {

			if err := m.PlacementNetworks[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("placement_networks" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *Pool) validateServerReselect(formats strfmt.Registry) error {

	if swag.IsZero(m.ServerReselect) { // not required
		return nil
	}

	if m.ServerReselect != nil {

		if err := m.ServerReselect.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("server_reselect")
			}
			return err
		}
	}
