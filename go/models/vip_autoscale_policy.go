...
type VipAutoscalePolicy struct {
	...
	// The maximum size of the group. Field introduced in 17.2.12.
	MaxSize int32 `json:"max_size,omitempty"`

	// The minimum size of the group. Field introduced in 17.2.12.
	MinSize int32 `json:"min_size,omitempty"`

	// When set, scaling is suspended. Field introduced in 17.2.12.
