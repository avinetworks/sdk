...
// Patch an existing VIMgrClusterRuntime object
// patchOp: add, replace, or delete
// payload should be compatible with the models.VIMgrClusterRuntime
// or it should be json compatible of form map[string]interface{}
func (client *VIMgrClusterRuntimeClient) Patch(obj *models.VIMgrClusterRuntime, patch interface{}, patchOp string) (*models.VIMgrClusterRuntime, error) {
	var robj *models.VIMgrClusterRuntime
	path := client.getAPIPath(*obj.UUID)
