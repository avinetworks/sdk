...
// Patch an existing AuthProfile object
// patchOp: add, replace, or delete
// payload should be compatible with the models.AuthProfile
// or it should be json compatible of form map[string]interface{}
func (client *AuthProfileClient) Patch(obj *models.AuthProfile, patch interface{}, patchOp string) (*models.AuthProfile, error) {
	var robj *models.AuthProfile
	path := client.getAPIPath(*obj.UUID)
