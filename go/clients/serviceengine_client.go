...
// Patch an existing ServiceEngine object
// patchOp: add, replace, or delete
// payload should be compatible with the models.ServiceEngine
// or it should be json compatible of form map[string]interface{}
func (client *ServiceEngineClient) Patch(obj *models.ServiceEngine, patch interface{}, patchOp string) (*models.ServiceEngine, error) {
	var robj *models.ServiceEngine
	path := client.getAPIPath(*obj.UUID)
