...
// Patch an existing SSLProfile object
// patchOp: add, replace, or delete
// payload should be compatible with the models.SSLProfile
// or it should be json compatible of form map[string]interface{}
func (client *SSLProfileClient) Patch(obj *models.SSLProfile, patch interface{}, patchOp string) (*models.SSLProfile, error) {
	var robj *models.SSLProfile
	path := client.getAPIPath(*obj.UUID)
