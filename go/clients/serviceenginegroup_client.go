...
// Patch an existing ServiceEngineGroup object
// patchOp: add, replace, or delete
// payload should be compatible with the models.ServiceEngineGroup
// or it should be json compatible of form map[string]interface{}
func (client *ServiceEngineGroupClient) Patch(obj *models.ServiceEngineGroup, patch interface{}, patchOp string) (*models.ServiceEngineGroup, error) {
	var robj *models.ServiceEngineGroup
	path := client.getAPIPath(*obj.UUID)
