...
// Patch an existing CloudConnectorUser object
// patchOp: add, replace, or delete
// payload should be compatible with the models.CloudConnectorUser
// or it should be json compatible of form map[string]interface{}
func (client *CloudConnectorUserClient) Patch(obj *models.CloudConnectorUser, patch interface{}, patchOp string) (*models.CloudConnectorUser, error) {
	var robj *models.CloudConnectorUser
	path := client.getAPIPath(*obj.UUID)
