...
// Patch an existing VIPGNameInfo object
// patchOp: add, replace, or delete
// payload should be compatible with the models.VIPGNameInfo
// or it should be json compatible of form map[string]interface{}
func (client *VIPGNameInfoClient) Patch(obj *models.VIPGNameInfo, patch interface{}, patchOp string) (*models.VIPGNameInfo, error) {
	var robj *models.VIPGNameInfo
	path := client.getAPIPath(*obj.UUID)
