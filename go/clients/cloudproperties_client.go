...
// Patch an existing CloudProperties object
// patchOp: add, replace, or delete
// payload should be compatible with the models.CloudProperties
// or it should be json compatible of form map[string]interface{}
func (client *CloudPropertiesClient) Patch(obj *models.CloudProperties, patch interface{}, patchOp string) (*models.CloudProperties, error) {
	var robj *models.CloudProperties
	path := client.getAPIPath(*obj.UUID)
