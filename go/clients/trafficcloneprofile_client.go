...
// Patch an existing TrafficCloneProfile object
// patchOp: add, replace, or delete
// payload should be compatible with the models.TrafficCloneProfile
// or it should be json compatible of form map[string]interface{}
func (client *TrafficCloneProfileClient) Patch(obj *models.TrafficCloneProfile, patch interface{}, patchOp string) (*models.TrafficCloneProfile, error) {
	var robj *models.TrafficCloneProfile
	path := client.getAPIPath(*obj.UUID)
