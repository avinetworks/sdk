...
// Patch an existing MicroService object
// patchOp: add, replace, or delete
// payload should be compatible with the models.MicroService
// or it should be json compatible of form map[string]interface{}
func (client *MicroServiceClient) Patch(obj *models.MicroService, patch interface{}, patchOp string) (*models.MicroService, error) {
	var robj *models.MicroService
	path := client.getAPIPath(*obj.UUID)
