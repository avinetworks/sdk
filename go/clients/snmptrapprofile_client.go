...
// Patch an existing SnmpTrapProfile object
// patchOp: add, replace, or delete
// payload should be compatible with the models.SnmpTrapProfile
// or it should be json compatible of form map[string]interface{}
func (client *SnmpTrapProfileClient) Patch(obj *models.SnmpTrapProfile, patch interface{}, patchOp string) (*models.SnmpTrapProfile, error) {
	var robj *models.SnmpTrapProfile
	path := client.getAPIPath(*obj.UUID)
