...
// Patch an existing Network object
// patchOp: add, replace, or delete
// payload should be compatible with the models.Network
// or it should be json compatible of form map[string]interface{}
func (client *NetworkClient) Patch(obj *models.Network, patch interface{}, patchOp string) (*models.Network, error) {
	var robj *models.Network
	path := client.getAPIPath(*obj.UUID)
