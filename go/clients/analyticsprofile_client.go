...
// Patch an existing AnalyticsProfile object
// patchOp: add, replace, or delete
// payload should be compatible with the models.AnalyticsProfile
// or it should be json compatible of form map[string]interface{}
func (client *AnalyticsProfileClient) Patch(obj *models.AnalyticsProfile, patch interface{}, patchOp string) (*models.AnalyticsProfile, error) {
	var robj *models.AnalyticsProfile
	path := client.getAPIPath(*obj.UUID)
